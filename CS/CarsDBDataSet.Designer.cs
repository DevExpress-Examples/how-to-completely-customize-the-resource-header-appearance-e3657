...
namespace SchedulerResHeaderTemplateExWpf.CarsDBDataSetTableAdapters {
    ...
    public partial class CarSchedulingTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SchedulerResHeaderTemplateExWpf.Properties.Settings.Default.CarsDBConnectionString;
        }
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Model`, `Picture`, `Price`) VALUES (?, ?, ?)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Model` = ?, `Picture` = ?, `Price` = ? WHERE ((`ID` = ?) AND (" +
                "(? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AND `Price` IS NULL) O" +
                "R (`Price` = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
